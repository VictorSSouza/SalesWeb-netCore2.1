...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            SalesRecord r2 = new SalesRecord(2, new DateTime(2019, 05, 12), 32300.0, SaleStatus.Billed, s5);
            ...
            SalesRecord r19 = new SalesRecord(19, new DateTime(2019, 10, 22), 8000.0, SaleStatus.Billed, s5);
            SalesRecord r20 = new SalesRecord(20, new DateTime(2019, 10, 15), 8000.0, SaleStatus.Billed, s6);
            ...
            SalesRecord r24 = new SalesRecord(24, new DateTime(2019, 10, 12), 8000.0, SaleStatus.Billed, s5);
            SalesRecord r25 = new SalesRecord(25, new DateTime(2019, 10, 31), 7000.0, SaleStatus.Billed, s3);
            ...
            SalesRecord r29 = new SalesRecord(29, new DateTime(2019, 10, 23), 12000.0, SaleStatus.Billed, s5);
